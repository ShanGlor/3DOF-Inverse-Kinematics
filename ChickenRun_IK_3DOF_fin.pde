...
{  
  ...
  arduino = new Arduino(this, Arduino.list()[0], 57600); //Select from the list your assigned COM port 
...
class Segment
{
  ...
  arduino.servoWrite(9, constrain(xpos, 0, 180));
  arduino.servoWrite(10, A2);  //knee angle
  arduino.servoWrite(11, A3);  //ankle angle
  }
}
